...
(
    ...
    KEY `FK_answers_author_id__users_id`
(
    `author_id`
),
    KEY `FK_answers_question_id__questions_id`
(
    `question_id`
),
    CONSTRAINT `FK_answers_author_id__users_id` FOREIGN KEY
(
    `author_id`
) REFERENCES `users`
(
    ...
    CONSTRAINT `FK_answers_question_id__questions_id` FOREIGN KEY
(
    `question_id`
...
INSERT INTO `answers` (`id`, `body`, `author_id`, `question_id`, `created_on`)
VALUES (1, 'nqkav otgovor', 2, 2, '2019-05-30 20:49:02'),
...
(
    ...
    KEY `FK_authentications_user_id__users_id`
(
    `user_id`
),
    CONSTRAINT `FK_authentications_user_id__users_id` FOREIGN KEY
(
    `user_id`
) REFERENCES `users`
(
...
INSERT INTO `authentications` (`auth_string`, `user_id`)
VALUES ('5cf0216e9e8b5', 1),
       ('5cf0255e2316c', 2),
       ('5cf02641a5457', 6);
...
(
    ...
    CONSTRAINT `FK_profiles_user_id__users_id` FOREIGN KEY
(
    `user_id`
) REFERENCES `users`
(
...
INSERT INTO `profiles` (`user_id`, `facebook_url`, `born_on`)
VALUES (1, 'fb.com/a', NULL),
       (2, NULL, '2019-05-27');
...
(
    ...
    KEY `FK_questions_category_id__categories_id`
(
    `category_id`
),
    KEY `FK_questions_author_id__users_id`
(
    `author_id`
),
    CONSTRAINT `FK_questions_author_id__users_id` FOREIGN KEY
(
    `author_id`
) REFERENCES `users`
(
    ...
    CONSTRAINT `FK_questions_category_id__categories_id` FOREIGN KEY
(
    `category_id`
...
INSERT INTO `questions` (`id`, `title`, `body`, `category_id`, `author_id`, `created_on`)
VALUES (1, 'Nov vapros',
        'Tui e nov vapros molq\r\nTui e nov vapros molq\r\nTui e nov vapros molq\r\nTui e nov vapros molq', 3, 2,
        '2019-05-30 20:07:42'),
...
(
    ...
    KEY `FK_questions_tags_tag_id__tags_id`
(
    `tag_id`
),
    CONSTRAINT `FK_questions_tags_question_id__questions_id` FOREIGN KEY
(
    `question_id`
) REFERENCES `questions`
(
    ...
    CONSTRAINT `FK_questions_tags_tag_id__tags_id` FOREIGN KEY
(
    `tag_id`
) REFERENCES `tags`
(
...
INSERT INTO `users` (`id`, `username`, `password`, `deleted_on`)
VALUES (1, 'pesho', '$argon2i$v=19$m=1024,t=2,p=2$NG9SZjNZZkpGTVVYN3AwNQ$DcdgRavrrxpZ1gVipHZreRIvyVff1ZD/T2U4rxFty8I',
        NULL),
       (2, 'gosho', '$argon2i$v=19$m=1024,t=2,p=2$cVV4OXhJeldCMkloOWFCRQ$h2KYTcu4bwOx2jsY6an/kPCU8M+DBMqbJrGFu+tafFY',
        NULL),
       (3, ' nov_user',
        '$argon2i$v=19$m=1024,t=2,p=2$VEU3WE9SWi9BL3dTcmpZZA$fPAU9Kk2geg1DRzwIiCWWNyH5b6lMDBEU/BKLHxdRv0', NULL),
       (4, 'nov_user_1',
        '$argon2i$v=19$m=1024,t=2,p=2$czBjWU90MnBiRlN1dy5Bbg$P7tUT4VmHWAQl1R9tD6pG/xCjTZ5cQfqG1w00iZ7IhU', NULL),
       (5, 'newUser', '$argon2i$v=19$m=1024,t=2,p=2$OWRrYzVXeldibWhDYVd4Qg$0jSqUpyQ9RUNDXlzpAug/7BJocYp4f2fhYbEfU8xONs',
        NULL),
       (6, 'asdsfdsg',
        '$argon2i$v=19$m=1024,t=2,p=2$VGZRZHFLY1gvVWkuUEltdQ$UAkYAgOMvNEVgfRw2n0o/s9WFP9zDKIj7sm/7h/2RNo', NULL);
...
(
    ...
    KEY `FK_users_roles_role_id__roles_id`
(
    `role_id`
),
    KEY `FK_users_roles_user_id__users_id`
(
    `user_id`
),
    CONSTRAINT `FK_users_roles_role_id__roles_id` FOREIGN KEY
(
    `role_id`
) REFERENCES `roles`
(
    ...
    CONSTRAINT `FK_users_roles_user_id__users_id` FOREIGN KEY
(
    `user_id`
) REFERENCES `users`
(
...
(
    ...
    KEY `user_likes_questions_id_fk`
(
    `question_id`
),
    CONSTRAINT `user_likes_questions_id_fk` FOREIGN KEY
(
    `question_id`
) REFERENCES `questions`
(
    ...
    CONSTRAINT `user_likes_users_id_fk` FOREIGN KEY
(
    `user_id`
) REFERENCES `users`
(
...
INSERT INTO `user_likes` (`user_id`, `question_id`)
VALUES (1, 1),
       (1, 2),
       (1, 3),
       (1, 5),
