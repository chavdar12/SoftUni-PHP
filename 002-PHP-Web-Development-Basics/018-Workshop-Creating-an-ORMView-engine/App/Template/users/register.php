...
<form method="post">
    ...
    <label>
        First Name: <input type="text" name="first_name" value="<?= $data === null ? null : $data->getFirstName() ?>"/>
        <br/>
    </label>
    <label>
        Last Name: <input type="text" name="last_name" value="<?= $data === null ? null : $data->getLastName() ?>"/>
        <br/>
    </label>
    <label>
